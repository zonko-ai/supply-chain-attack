...
const APP_NAME = process.env.AMIFCKED_COMMAND_NAME || 'amifcked';
const OUTPUT_STYLE = process.env.AMIFCKED_OUTPUT_STYLE === 'professional' ? 'professional' : 'amifcked';
const APP_FACE = OUTPUT_STYLE === 'amifcked' ? [
  '        .-\"\"\"\"-.',
  '      .\'  _    _  \'.',
  '     /   (o)  (o)   \\',
  '    |       ____       |',
...
const COPY = OUTPUT_STYLE === 'professional' ? {
  ...
  educationTitle: 'Findings explanation',
  ...
  noFindingTitle: 'Tiny reality check',
  noFindingBody: 'No known bad package versions were found in the scanned package-manager state. That is good. It is not a full malware exorcism.',
  findingsTitle: 'The shit that pinged',
  promptPrefix: 'more?',
  findingVerdict: 'YOU ARE FUCKED!!',
  cleanVerdict: 'YOU ARE NOT FUCKED',
  educationTitle: 'Education mode: what the hell did I just find?',
  noMatchExplanation: 'No known bad package versions matched the embedded advisory snapshot. That means the scanned package-manager state did not contain the specific versions amifcked knows about.',
  noGuarantee: 'It does NOT prove this machine is malware-free. Supply-chain attacks move fast, caches can be weird, and clean snapshots are not force fields.',
  iocWarning: 'These file names and contents resemble persistence or credential-exfiltration leftovers from recent supply-chain campaigns. That is not cute. Inspect them before deleting so you understand what changed.',
  nextActionsTitle: 'Next actions: copy/paste this into your agent',
};
